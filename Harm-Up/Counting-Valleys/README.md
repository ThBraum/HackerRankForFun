...
every step it was noted if it was an uphill, `U`, or a downhill, `D`. Hikes always start and end at sea level,
...
In many languages the solution is to count how many times the altitude rises from -1 to 0 (i.e., when you come
up out of a valley). A simple pseudocode:
...
This README reproduces the "Counting Valleys" problem statement as shown in the provided image.
